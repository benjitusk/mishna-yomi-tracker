...
export function MishnaCard({ seder, tractate, chapter, isCompleted, isToday, onToggle }: MishnaCardProps) {
  return (
    <Card
      className={cn("transition-all hover:shadow-md", isToday && "ring-2 ring-accent", isCompleted && "opacity-75")}
    >
