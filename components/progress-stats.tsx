...
import { TOTAL_CHAPTERS } from "@/lib/mishna-data"
...
export function ProgressStats({ completedCount, currentStreak, longestStreak, lastStudyDate }: ProgressStatsProps) {
  const progressPercentage = (completedCount / TOTAL_CHAPTERS) * 100
